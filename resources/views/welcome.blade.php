...
<main class="bg-gray-100 font-montserrat">
    <header class="flex items-center h-24 sm:h-32">
        <div class="container flex items-center justify-between px-6 mx-auto sm:px-12">
            <div class="flex items-start text-2xl font-black text-blue-900">
                {{-- UTP<span class="w-3 h-3 ml-2 bg-purple-600 rounded-full"></span> --}}
            </div>
        </div>
    </header>
    <div class="container relative flex flex-col-reverse px-6 mx-auto sm:px-12 sm:flex-row">
        <div class="relative z-10 sm:w-6/12">
            <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                viewBox="0 0 280.34 335.07">
                <defs>
                    <linearGradient id="linear-gradient" x1="111.49" y1="261.12" x2="145.91" y2="370.59"
                        gradientUnits="userSpaceOnUse">
                        <stop offset="0" stop-color="#2a2839" />
                        <stop offset="1" stop-color="#38435d" />
                    </linearGradient>
                    <linearGradient id="linear-gradient-2" x1="89.14" y1="228.36" x2="83.5" y2="359.38"
                        xlink:href="#linear-gradient" />
                    <linearGradient id="linear-gradient-3" x1="126.34" y1="149.56" x2="155.41" y2="149.56"
                        gradientUnits="userSpaceOnUse">
                    ...
                    <linearGradient id="linear-gradient-4" x1="164.01" y1="151.48" x2="147.49" y2="173.66"
                        xlink:href="#linear-gradient-3" />
                    <linearGradient id="linear-gradient-5" x1="86.84" y1="99.43" x2="102.91" y2="103.45"
                        gradientUnits="userSpaceOnUse">
                        <stop offset="0" stop-color="#fff" stop-opacity="0" />
                        <stop offset="1" stop-color="#d1b6cb" />
                    </linearGradient>
                    <linearGradient id="linear-gradient-6" x1="127.49" y1="111.21" x2="137.67" y2="159.59"
                        xlink:href="#linear-gradient-3" />
                    <linearGradient id="linear-gradient-7" x1="92.58" y1="96.08" x2="92.58" y2="232.64"
                        xlink:href="#linear-gradient-3" />
                    <linearGradient id="linear-gradient-8" x1="110.75" y1="212.47" x2="110.75" y2="115.93"
                        xlink:href="#linear-gradient" />
                    <linearGradient id="linear-gradient-9" x1="1046.73" y1="383.6" x2="1112" y2="382.91"
                    ...
                    <linearGradient id="linear-gradient-10" x1="102.62" y1="116.25" x2="102.62" y2="105.35"
                        xlink:href="#linear-gradient" />
                    <linearGradient id="linear-gradient-11" x1="91" y1="95.76" x2="91" y2="112.53"
                        xlink:href="#linear-gradient-3" />
                    <linearGradient id="linear-gradient-12" x1="110.58" y1="95.76" x2="110.58" y2="112.53"
                        xlink:href="#linear-gradient-3" />
                    <linearGradient id="linear-gradient-13" x1="76.12" y1="131.17" x2="62.87" y2="198.72"
                        xlink:href="#linear-gradient-3" />
                </defs>
                ...
                <g style="isolation:isolate">
                    <g id="Capa_1" data-name="Capa 1">
                        ...
                        <path d="M236.84,30.58l-1.18.78"
                            style="fill:none;stroke:#8382b3;stroke-miterlimit:10;stroke-width:0.992126px" />
                        <path
                            ...
                            style="fill:none;stroke:#8382b3;stroke-miterlimit:10;stroke-width:0.992126px;stroke-dasharray:2.864720106124878,5.729430198669434" />
                        <path d="M.85,104.49c-.12.45-.25.91-.37,1.37"
                            style="fill:none;stroke:#8382b3;stroke-miterlimit:10;stroke-width:0.992126px" />
                        <path
                        ...
                        <polygon points="153.27 156.37 161.15 155.42 161.15 148.86 153.27 149.56 153.27 156.37"
                            style="fill:#afbad6" />
                        <path
                        ...
                        <path
                            ...
                            style="fill:#fff" />
                        <path d="M115.68,65c-.53-.2-.84,1.4-.76,1.75a1.7,1.7,0,0,0,1.62,1.44c1.83.27,2.22-2,2.22-2Z"
                            style="fill:#4c323a" />
                        <path d="M118,66.5c-.79-.06-1.3.75-.83,1.18s1.16.6,1.38-.05S118.76,66.56,118,66.5Z"
                        ...
                        <path
                            ...
                            style="fill:#783a40" />
                        <path d="M128.61,69s0,2.37-1.34,2.64c-1.73.37-1.83-1.48-1.78-2.74A3,3,0,0,1,128.61,69Z"
                            style="fill:#fff" />
                        <path
                            d="M128.62,69.36c.41.13-.1,1.31-.3,1.49a1.21,1.21,0,0,1-1.63.13c-1.25-.72-.47-2.39-.47-2.39Z"
                            style="fill:#4c323a" />
                        <path d="M128.58,70c.59.38.54,1.25,0,1.3s-1.12-.2-.95-.79S128,69.62,128.58,70Z"
                            style="fill:#fff;opacity:0.35000000000000003" />
                        <path
                        ...
                        <path
                            ...
                            style="fill:#e7bfaa" />
                        <polygon points="102.08 143.4 108.98 140.01 115.27 153.95 108.54 158.84 102.08 143.4"
                            style="fill:#afbad6" />
                        <path
                        ...
                        <polygon points="78.83 91.79 106.12 105.34 95.07 113.79 75.88 96.08 78.83 91.79"
                            style="fill:url(#linear-gradient-11)" />
                        <polygon points="106.12 105.34 115.03 111.93 113.2 100.35 110.3 97.06 106.12 105.34"
                        ...
                        <path
                            ...
                            style="fill:#d5daee" />
                        <line x1="194.99" y1="160.1" x2="194.99" y2="172.78"
                            style="fill:none;stroke:#eaf0f2;stroke-miterlimit:10;stroke-width:0.30236199999999996px" />
                        <path d="M201.49,159.22a6.51,6.51,0,1,1-6.5-6.36A6.43,6.43,0,0,1,201.49,159.22Z"
                            style="fill:#807fb4" />
                        <path d="M201.49,181.51a6.51,6.51,0,1,1-6.5-6.36A6.43,6.43,0,0,1,201.49,181.51Z"
                            style="fill:#807fb4" />
                        <polygon points="194.47 161.72 191.47 157.94 194.19 159.05 200.46 153.69 194.47 161.72"
                            style="fill:#fff" />
                        <polygon points="194.47 184.26 191.47 180.47 194.19 181.59 200.46 176.23 194.47 184.26"
                            style="fill:#fff" />
        ...
        <div
            class="relative z-10 flex flex-col items-start mt-8 mb-16 ml-auto sm:w-5/12 xl:w-4/12 sm:items-end sm:text-right sm:mt-0 xl:pt-20 sm:mb-0">
            <h1 class="mb-4 text-4xl font-black leading-none text-blue-900 lg:text-5xl">{{ config('app.name') }}</h1>
            <p class="mb-4 text-blue-900 lg:text-lg sm:mb-12">A system to help organize Industrial Visits. Special made
                with love for student, lecturers and university management. Stop worrying about visit and focus on project.
            </p>
            <div class="flex flex-row">
                @if (Route::has('login'))
                @auth
                <a href="{{ route('internship.dashboard') }}"
                    class="px-12 py-3 text-lg font-semibold text-white bg-blue-600 rounded-full hover:bg-blue-400">Dashboard</a>
                @else
                <a href="{{ route('login') }}"
                    class="px-12 py-3 mr-2 text-lg font-semibold text-white bg-green-600 rounded-full hover:bg-blue-400">Login</a>

                @if (Route::has('register'))
                <a href="{{ route('register') }}"
                    class="px-12 py-3 text-lg font-semibold text-white bg-blue-600 rounded-full hover:bg-blue-400">Student
                    Register</a>
                @endif
                @endauth
                @endif
        ...
        <svg class="absolute bottom-0 left-0 w-full" id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 497.5 141.26">
            <title>skyline</title>
            <rect x="330.19" y="60.71" width="4.83" height="2.04" transform="translate(665.21 123.45) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="329.57" y="62.3" width="6.07" height="0.89" transform="translate(665.21 125.48) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="328.06" y="63.18" width="9.1" height="2.3" transform="translate(665.21 128.67) rotate(180)"
                style="fill:#bebcdb" />
            <polygon points="332.04 40.63 333.17 40.63 332.77 30 332.45 30 332.04 40.63" style="fill:#bebcdb" />
            <path d="M331.32,40.45v20.7h2.57V40.45Zm1.46,9.1h.34V60.26h-.34Zm-.69,0h.35V60.26h-.35Z"
                style="fill:#bebcdb" />
            ...
            <rect x="320.95" y="50.58" width="18.44" height="92.45" transform="translate(660.35 193.6) rotate(180)"
                style="fill:#bebcdb" />
            ...
            <polygon points="103.21 148.86 103.21 79.28 116.61 79.28 123.81 86.73 123.81 148.86 103.21 148.86"
                style="fill:#bebcdb" />
            <polygon
            ...
            <rect x="195.68" y="50.74" width="1.17" height="43.49" transform="translate(392.53 144.97) rotate(180)"
                style="fill:#d5daee" />
            <rect x="198.28" y="50.74" width="1.17" height="43.49" transform="translate(397.74 144.97) rotate(180)"
                style="fill:#d5daee" />
            ...
            <rect x="475.89" y="74.73" width="0.92" height="33.92" transform="translate(952.7 183.37) rotate(180)"
                style="fill:#d5daee" />
            <rect x="477.93" y="74.73" width="0.92" height="33.92" transform="translate(956.77 183.37) rotate(180)"
                style="fill:#d5daee" />
            ...
            <polygon
                ...
                style="fill:#ada7ce" />
            <rect x="22.85" y="101.9" width="3.51" height="0.31" transform="translate(49.2 204.11) rotate(180)"
                style="fill:#fffffc" />
            <rect x="21.97" y="102.21" width="5.26" height="5.27" transform="translate(49.2 209.69) rotate(180)"
                style="fill:#d0d4ea" />
            ...
            <rect x="12.52" y="100.01" width="11.2" height="29.05" transform="translate(36.24 229.08) rotate(180)"
                style="fill:#e6f1f5" />
            ...
            <rect x="236.38" y="70.31" width="6.24" height="1.66" transform="translate(479 142.28) rotate(180)"
                style="fill:#f3f8f5" />
            <rect x="235.58" y="71.61" width="7.83" height="0.72" transform="translate(479 143.94) rotate(180)"
                style="fill:#f3f8f5" />
            <rect x="233.63" y="72.33" width="11.74" height="12.1" transform="translate(479 156.76) rotate(180)"
                style="fill:#afaacf" />
            ...
            <rect x="384.77" y="88.67" width="4.78" height="1.27" transform="translate(774.33 178.62) rotate(180)"
                style="fill:#f3f8f5" />
            <rect x="384.16" y="89.67" width="6" height="0.55" transform="translate(774.33 179.89) rotate(180)"
                style="fill:#f3f8f5" />
            <rect x="382.66" y="90.22" width="9" height="9.27" transform="translate(774.33 189.72) rotate(180)"
                style="fill:#afaacf" />
            ...
            <rect x="144.5" y="83.05" width="4.91" height="7.24" transform="translate(293.91 173.35) rotate(180)"
                style="fill:#ada7ce" />
            <rect x="147.62" y="87.15" width="6.4" height="5.51" transform="translate(301.65 179.82) rotate(180)"
                style="fill:#ada7ce" />
            <rect x="174.03" y="31.75" width="8.66" height="8.92" transform="translate(356.72 72.41) rotate(180)"
                style="fill:#ada7ce" />
            <polygon
                ...
                style="fill:#d9e0f0" />
            <rect x="135.14" y="104.9" width="8.6" height="2.35" transform="translate(278.88 212.15) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="135.14" y="109.19" width="8.6" height="2.35" transform="translate(278.88 220.73) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="135.14" y="113.48" width="8.6" height="2.35" transform="translate(278.88 229.31) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="135.14" y="117.77" width="8.6" height="2.35" transform="translate(278.88 237.89) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="135.14" y="122.06" width="8.6" height="2.35" transform="translate(278.88 246.47) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="135.14" y="126.35" width="8.6" height="2.35" transform="translate(278.88 255.05) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="135.14" y="130.64" width="8.6" height="2.35" transform="translate(278.88 263.62) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="135.14" y="134.93" width="8.6" height="2.35" transform="translate(278.88 272.2) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="135.14" y="139.22" width="8.6" height="2.35" transform="translate(278.88 280.78) rotate(180)"
                style="fill:#bebcdb" />
            ...
            <rect x="378.9" y="50.74" width="1.17" height="43.49" transform="translate(758.97 144.97) rotate(180)"
                style="fill:#d5daee" />
            <rect x="381.5" y="50.74" width="1.17" height="43.49" transform="translate(764.18 144.97) rotate(180)"
                style="fill:#d5daee" />
            ...
            <rect x="428.48" y="93" width="3.2" height="0.85" transform="translate(860.16 186.85) rotate(180)"
                style="fill:#f3f8f5" />
            <rect x="428.07" y="93.66" width="4.02" height="0.37" transform="translate(860.16 187.7) rotate(180)"
                style="fill:#f3f8f5" />
            <rect x="427.07" y="94.04" width="6.03" height="6.21" transform="translate(860.16 194.28) rotate(180)"
                style="fill:#afaacf" />
            ...
            <rect x="357.25" y="31.75" width="8.66" height="8.92" transform="translate(723.16 72.41) rotate(180)"
                style="fill:#ada7ce" />
            <polygon
                ...
                style="fill:#d9e0f0" />
            <rect x="318.36" y="104.9" width="8.6" height="2.35" transform="translate(645.32 212.15) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="318.36" y="109.19" width="8.6" height="2.35" transform="translate(645.32 220.73) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="318.36" y="113.48" width="8.6" height="2.35" transform="translate(645.32 229.31) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="318.36" y="117.77" width="8.6" height="2.35" transform="translate(645.32 237.89) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="318.36" y="122.06" width="8.6" height="2.35" transform="translate(645.32 246.47) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="318.36" y="126.35" width="8.6" height="2.35" transform="translate(645.32 255.05) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="318.36" y="130.64" width="8.6" height="2.35" transform="translate(645.32 263.62) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="318.36" y="134.93" width="8.6" height="2.35" transform="translate(645.32 272.2) rotate(180)"
                style="fill:#bebcdb" />
            <rect x="318.36" y="139.22" width="8.6" height="2.35" transform="translate(645.32 280.78) rotate(180)"
                style="fill:#bebcdb" />
            ...
            <rect x="79.41" y="100.91" width="0.75" height="30.11" transform="translate(159.57 231.93) rotate(180)"
                style="fill:#b9b5d6" />
            <rect x="81.08" y="100.91" width="0.75" height="30.11" transform="translate(162.91 231.93) rotate(180)"
                style="fill:#b9b5d6" />
            <rect x="82.74" y="100.91" width="0.75" height="30.11" transform="translate(166.24 231.93) rotate(180)"
                style="fill:#b9b5d6" />
            <rect x="84.41" y="100.91" width="0.75" height="30.11" transform="translate(169.57 231.93) rotate(180)"
                style="fill:#b9b5d6" />
            <rect x="78.57" y="68.02" width="16.45" height="80.84" transform="translate(173.59 216.88) rotate(180)"
                style="fill:#ada7ce" />
            <polygon points="56.68 126.42 66.64 126.42 66.64 97.82 56.68 126.42" style="fill:#f3f8f5" />
            <rect x="52.41" y="65.55" width="12.23" height="44.58" transform="translate(117.05 175.69) rotate(180)"
                style="fill:#ada7ce" />
            <rect x="65.61" y="94.04" width="5.68" height="0.47" transform="translate(136.89 188.55) rotate(180)"
                style="fill:#fffffc" />
            ...
            <rect x="75.93" y="78.3" width="5.28" height="5.6" transform="translate(157.13 162.2) rotate(180)"
                style="fill:#d5daee" />
            <rect x="52.55" y="111.74" width="7.7" height="37.12" style="fill:#ada7ce" />
            <rect x="107.48" y="49.53" width="18.2" height="1.6" transform="translate(233.16 100.67) rotate(180)"
                style="fill:#d0d4ea" />
            <rect x="107.48" y="52.46" width="18.2" height="1.6" transform="translate(233.16 106.51) rotate(180)"
                style="fill:#d0d4ea" />
            <rect x="107.48" y="55.38" width="18.2" height="1.6" transform="translate(233.16 112.36) rotate(180)"
                style="fill:#d0d4ea" />
            <rect x="107.48" y="58.3" width="18.2" height="1.6" transform="translate(233.16 118.21) rotate(180)"
                style="fill:#d0d4ea" />
            <rect x="107.48" y="61.23" width="18.2" height="1.6" transform="translate(233.16 124.06) rotate(180)"
                style="fill:#d0d4ea" />
            <rect x="107.48" y="64.15" width="18.2" height="1.6" transform="translate(233.16 129.91) rotate(180)"
                style="fill:#d0d4ea" />
            <rect x="107.48" y="67.08" width="18.2" height="1.6" transform="translate(233.16 135.75) rotate(180)"
                style="fill:#d0d4ea" />
            <rect x="107.48" y="70" width="18.2" height="1.6" transform="translate(233.16 141.6) rotate(180)"
                style="fill:#d0d4ea" />
            <rect x="107.48" y="72.92" width="18.2" height="1.6" transform="translate(233.16 147.45) rotate(180)"
                style="fill:#d0d4ea" />
